    ...
    def run(self, episodes=10000):
        ...
        for ep in range(episodes):
            ...
            if ep % 20 == 0:
                ...
                if eval_reward >= 19:
                    model_path = os.path.join(self.save_dir, f"model_reward{eval_reward:.0f}_ep{ep}.pt")
                    torch.save(self.q_net.state_dict(), model_path)
                    print(f"Saved model at reward {eval_reward} to {model_path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb-run-name", type=str, default="pong-task2")
